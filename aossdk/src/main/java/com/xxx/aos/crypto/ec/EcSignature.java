...
public class EcSignature {
    ...
    public EcSignature( String base58Str ){
        ...
        this.curveParam = AosEcUtil.getCurveParamFrom( parts[1]);
        byte[] rawBytes = AosEcUtil.getBytesIfMatchedRipemd160( parts[2], parts[1], null);
    ...
    public String eosEncodingHex( boolean compressed ) {
        ...
        return AosEcUtil.encodeEosCrypto( PREFIX, curveParam , sigData);
    }
